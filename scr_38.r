setwd("C:\\Users\\QCRI-L002\\Desktop\\Collect_all_in_all\\V_hg38///")
library("biomaRt")
ensembl38 <- useMart(host='asia.ensembl.org', biomart='ENSEMBL_MART_ENSEMBL') #select the ensembl version that contains hg19 (GRch37) 
ensembl <- useDataset("hsapiens_gene_ensembl",mart= ensembl38) #select human genes
...
gInfo_hg38 = gInfo
save (gInfo_hg38,file = "gInfo_hg38.RData")
